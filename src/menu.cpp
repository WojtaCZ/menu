...
static void initTheme() {
    ...
    theme.checkboxSelEmpty   = ui::makeIconRef(checkbox_empty);
    theme.checkboxSelChecked = ui::makeIconRef(checkbox_empty_checked);
    theme.checkboxUnselEmpty   = ui::makeIconRef(checkbox_filled);
    theme.checkboxUnselChecked = ui::makeIconRef(checkbox_filled_checked);
